...
const LoginScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.backgroundCircle, styles.backgroundCircle2, styles.backgroundCircle3]} />
      <View style={[styles.backgroundCircle, styles.backgroundCircle2, styles.backgroundCircle3, styles.backgroundCircle4]} />
